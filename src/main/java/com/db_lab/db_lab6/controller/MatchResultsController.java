...
import com.db_lab.db_lab6.service.MatchResultsService;
...
public class MatchResultsController {
    ...
    public MatchResultsController(MatchResultsService matchResultsService, SecurityService securityService) {
        this.matchResultsService = matchResultsService;
        this.securityService = securityService;
    }

    @Operation(summary = "get all MatchResults(for admins)")
    @GetMapping
    ...
    @Operation(summary = "create MatchResults (for authorized users)")
    @PostMapping
    public ResponseEntity<HttpStatus> createMatchResults(@RequestBody MatchResults matchResults) {
        matchResultsService.createMatchResults(matchResults);
