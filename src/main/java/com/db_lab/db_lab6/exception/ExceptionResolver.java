...
public class ExceptionResolver {
    ...
    @ExceptionHandler(value = FootballClubNotFoundException.class)
    ResponseEntity<HttpStatus> FootballClubNotFoundException(){
        log.info("FootballClubNotFound exception!!!");
        return new ResponseEntity<>(HttpStatus.NOT_FOUND);
    }
