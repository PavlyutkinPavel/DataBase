# DataBase
## 1. 
Приложение для коммуникации пользователей фан-сообщества футбольного клуба; Павлюткин Павел Сергеевич; 153501
## 2. 

1) Регистрация и аутентификация:

Пользователи могут зарегистрироваться в системе, указав свое имя, адрес электронной почты и пароль.
Зарегистрированные пользователи могут аутентифицироваться с использованием логина и пароля.

2) Форум:

Пользователи могут создавать новые темы на форуме и создавать посты в существующих темах.
Функция редактирования и удаления собственных постов.
Модерация форума для управления контентом.
...
Отображение информации о футбольном клубе, включая его название, местоположение, достижения и стадион.
